...
const TimeWindowBar = ({ startTime = "09:00", endTime = "20:00" }) => {
  ...
  console.log('🕐 TimeWindowBar props:', { startTime, endTime });
  console.log('🕐 Current time:', currentTime, `→ ${currentPercent}% of day`);
  ...
  const formatTime = (time) => {
    ...
    console.log('🕐 formatTime:', { input: time, output: formatted, h, ampm, displayHour });
    return formatted;
  };
  ...
  const stars = [
   ...
   return (
    <div style={{ width: '100%', marginTop: '4px' }}>
      ...
      <div style={{ position: 'relative', height: '48px', borderRadius: '8px', overflow: 'hidden', background: 'linear-gradient(to right, #0f172a 0%, #1e3a5a 25%, #fef3c7 50%, #1e3a5a 75%, #0f172a 100%)' }}>
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 60% 100% at 50% 0%, rgba(251, 191, 36, 0.3) 0%, transparent 70%)' }} />
        ...
        <div style={{ position: 'absolute', top: 0, height: '100%', left: `${startPercent}%`, width: `${width}%`, background: 'rgba(255, 255, 255, 0.1)', borderLeft: '1px solid rgba(255, 255, 255, 0.2)', borderRight: '1px solid rgba(255, 255, 255, 0.2)' }} />
         ...
         <div style={{ position: 'absolute', top: 0, height: '100%', width: '2px', background: '#EF4444', left: `${currentPercent}%`, boxShadow: '0 0 4px rgba(239, 68, 68, 0.5)', zIndex: 10 }} />
       </div>
{/* 
      <div style={{ position: 'relative', marginTop: '8px', height: '20px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Payment of ₹{paymentSuccessAmount} completed successfully
            </p>
            <button
           ...
           <div className="stats-grid">
             ...
             <div className="stat-box stat-box-1x1" style={{ background: 'linear-gradient(135deg,rgb(255, 255, 255) 0%,rgb(255, 255, 255) 100%)' }}>
              ...
              <div className="stat-box stat-box-1x1" style={{ background: 'linear-gradient(135deg,rgb(255, 255, 255) 0%,rgb(255, 255, 255) 100%)' }}>
                ...
                <div className="stat-box stat-box-3x1">
                  ...
                  <div className="stat-box-content" style={{ paddingTop: '8px' }}>
                    {(() => {
                      const combined = cardMetrics.walletStats?.callingWindow || "09:00 - 20:00";
                      const [start, end] = combined.split(' - ');
                      return <TimeWindowBar startTime={start} endTime={end} />;
                    })()}
                  </div>
                </div>
              ...
              <div className="stat-box stat-box-1x1" style={{ background: 'linear-gradient(135deg,rgb(255, 255, 255) 0%,rgb(255, 255, 255) 100%)' }}>
                ...
                <div className="stat-box-content">
                  <div className="stat-box-number" style={{ color: 'rgb(0, 0, 0)' }}>
                    {loadingCardMetrics ? '—' : `₹${(cardMetrics.remainingSpendingLimit || 0).toLocaleString()}`}
                  </div>
                  <div className="stat-box-change" style={{ color: 'rgba(0, 0, 0, 0.8)' }}>
